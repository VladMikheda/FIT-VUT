def gen_quiz(qpool, *index, altcodes=tuple('ABCDEF'), quiz=None):
    '''
    ...
    for i in index:
        ...
        try:
            ...
            new_l = []
            for num_and_answ in zip(altcodes, add_t[1]):
                new_l.append(num_and_answ[0] + ": " + num_and_answ[1])

            quiz.append((add_t[0], new_l))
    return quiz
