...
\begin{quotation}
    Čím více \textit{druhů}, \textbf{řezů}, {\tiny velikostí}, \textcolor{red}{barev} písma a~jiných \textsc{efektů} použijeme, tím \texttt{profesionálněji} bude \fontfamily{pzc}\selectfont {\Large dokument} \fontfamily{cmr}\selectfont vypadat.
